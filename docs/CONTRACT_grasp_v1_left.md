...
| 자산 매니페스트 | `openarm_tesollo_bi_s_rl_manifest.yaml` |
| Fabrics 자산 | `openarm_tesollo_bi_s_left` / `OpenArmTeoslloLeftPoseFabric` |
| Fabrics 월드 | `open_tesollo_left_boxes_no_table` |
| hdgp 패키지 | `openarm.tesollo.left.grasp_v1` |
...
`q_home` (sim preset 유도) = `[-0.3082, -0.5785, -0.097, 0.5811, -0.2676, -0.5281, -0.5792]`
